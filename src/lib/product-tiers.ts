...
export const PRODUCT_TIERS: ProductTier[] = [
  {
    ...
    products: [
      ...
      },
      {
        ...
        forWho: "The guy who wants 24/7 guidance at zero commitment.",
        description: COUNSEL_AI.description,
        priceLabel: `$${COUNSEL_AI.priceUsd}${COUNSEL_AI.cadence}`,
        priceNote: `First ${COUNSEL_AI.trialDays} days free`,
        nudge: "Always-available safety net — when it gets specific enough, it points you to Axel.",
        paymentLinkEnvKey: COUNSEL_AI.paymentLinkEnvKey,
        productsAnchor: "#counsel",
